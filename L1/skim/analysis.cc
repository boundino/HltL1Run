...
const int adc_bin_min = 0, adc_bin_max = 20, adc_nbin = adc_bin_max-adc_bin_min;
const int ratio_bin_min = 0, ratio_bin_max = 20, ratio_nbin = ratio_bin_max-ratio_bin_min;
...
void skim(std::string inputname, std::string outputname)
{
  ...
  outf->cd();
  TH2F* hlongvsshort_signal = new TH2F("hlongvsshort_signal", ";Short;Long", adc_nbin, adc_bin_min, adc_bin_max, adc_nbin, adc_bin_min, adc_bin_max);
  TH2F* hlongvsshort_noise = new TH2F("hlongvsshort_noise", ";Short;Long", adc_nbin, adc_bin_min, adc_bin_max, adc_nbin, adc_bin_min, adc_bin_max);
  TH1F* hlongovershort_signal = new TH1F("hlongovershort_signal", ";HF Energy ratio (long/short);", ratio_nbin, ratio_bin_min, ratio_bin_max);
  TH1F* hlongovershort_noise = new TH1F("hlongovershort_noise", ";HF Energy ratio (long/short);", ratio_nbin, ratio_bin_min, ratio_bin_max);
