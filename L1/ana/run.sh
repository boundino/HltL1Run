...
inputs=(
    /raid5/data/wangj/L1PbPb2022/skim_L1NtupleRAWEMUCalo_HFAdc_smallStat_326822.root,configs/run326822.conf,326822,100
    ...
    /raid5/data/wangj/L1PbPb2022/evtmatching_20220512_HIForward_HIRun2018A_HIZeroBiasv1_run327327_fixmatch.root,configs/run327327.conf,327327,75
)
