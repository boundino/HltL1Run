...
process = cms.Process('HiForest',Run3_pp_on_PbPb_approxSiStripClusters_2024)
...
# process.GlobalTag = GlobalTag(process.GlobalTag, '141X_dataRun3_Prompt_Candidate_2024_10_27_01_04_52', '')
# process.GlobalTag = GlobalTag(process.GlobalTag, '141X_dataRun3_Prompt_Candidate_2024_11_02_04_01_03', '') # 1300V
...
process.zdcrecoRun3.ootpuFracHAD = cms.double(115.0/256.0)
process.zdcrecoRun3.ootpuFracEM = cms.double(115.0/256.0)
# 97.0/256.0, 115.0/256.0
process.zdcanalyzer.doZdcDigis = cms.bool(False)

# COND = ""
# if COND == "hcal2023Prompt":
#     tag_HcalGainsRcd = "HcalGains_2023_v2.0_data"
#     tag_HcalRespCorrs = "HcalRespCorrs_2023_v3.0_data"
#     tag_HcalPedestals_effective = "HcalPedestals_2023_v1.4_data_effective"
#     tag_HcalPedestalWidths_effective = "HcalPedestalWidths_2023_v1.4_data_effective"
# if COND == "hcal2024Express":
#     tag_HcalGainsRcd = "HcalGains_v3.0_hlt" # ?
#     tag_HcalRespCorrs = "HcalRespCorrs_2024_v3.0_data"
#     tag_HcalPedestals_effective = "HcalPedestals_2024_v3.4_data_effective"
#     tag_HcalPedestalWidths_effective = "HcalPedestalWidths_2024_v3.4_data_effective"
# if COND == "hcal2024Prompt":
#     tag_HcalGainsRcd = "HcalGains_2024_v2.0_data"
#     tag_HcalRespCorrs = "HcalRespCorrs_2024_v3.0_data"
#     tag_HcalPedestals_effective = "HcalPedestals_2024_v3.4_data_effective"
#     tag_HcalPedestalWidths_effective = "HcalPedestalWidths_2024_v3.4_data_effective"

# print(tag_HcalGainsRcd)
# print(tag_HcalRespCorrs)
...
process.es_ascii = cms.ESSource('HcalTextCalibrations',
   input = cms.VPSet(
      ...
      #    file   = cms.FileInPath('ZDCConditions_1400V/DumpPedestals_PostAccess.txt')
      # ),
      cms.PSet(
...
# ivars.inputFiles = 'file:/eos/cms/store/group/phys_heavyions/wangj/RECO2024/miniaod_PhysicsHIPhysicsRawPrime15_387867_ZB_hcal2023Prompt/reco_run387867_ls0051_streamPhysicsHIPhysicsRawPrime15_StorageManager.root'
ivars.outputFile = '/eos/cms/store/group/phys_heavyions/wangj/Forest2024/CRAB_UserFiles/crab_forestadc_HIPhysicsRawPrime0_388056_ZB.root'
...
# process.source.lumisToProcess = cms.untracked.VLuminosityBlockRange('387867:35-387867:64')
